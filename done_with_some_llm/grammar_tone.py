...
API_KEY = "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"
print(API_KEY)
    ...
    payload = {
        ...
        "messages": [
            {"role": "system", "content":"""
                ...
                1. correct all the grammar mistakes (output the corrected text without any grammar mistakes).
