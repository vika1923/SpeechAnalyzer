...
def get_grammar_corrections(text: str):
    ...
    mistakes_lines, corrected_text, correction_spans = (
        grammar_tone.get_mistakes_and_text(text)
    )
    ...
    try:
        ...
        for (start_time, end_time), word in sorted_words:
            ...
            if word_start != -1:
                ...
                logger.warning(
                    f"Could not find word '{word}' in full text at position {current_pos}"
                )
...
def process_video_analysis_sync(job_id: str, file_path: str):
    ...
    try:
        ...
        if audio_path is None:
            ...
            jobs[job_id][
                "error"
            ] = "No audio track found in video or conversion failed."
            return
        ...
        timestamped_transcript_by_words = speech_to_text.speech_to_words(
        ...
        full_unpunctuated_text = " ".join(
            word for _, word in timestamped_transcript_by_words.items()
        )
        ...
        if full_text is None:
            ...
            jobs[job_id][
                "error"
            ] = "Failed to add punctuation to text. Please check your OpenAI API key."
            return
        ...
        word_boundary_mapping = create_word_boundary_mapping(
            timestamped_transcript_by_words, full_text
        )
        try:
        ...
        mistakes_lines, corrected_text, correction_spans = get_grammar_corrections(
            full_text
        )
            ...
            if '"' in line and "should be" in line:
                try:
                    ...
                    grammar_mistakes.append(
                        [[start, end], correct_phrase, incorrect_phrase]
                    )
                except Exception:
                    continue
            else:
        ...
        rate_of_speech_points = rate_of_speech.get_rate_of_speech(
            timestamped_transcript_by_words
        )
        ...
        if gaze_tracking == []:
            gaze_x = [
                ...
                -0.1711910838617853,
                0.11491057940419953,
                0.004334469056694061,
                -0.10529937610687529,
                0.0432013785889605,
                -0.023371058351204788,
                0.028176421757895982,
                -0.22639001418197527,
                -0.053626803611791965,
                -0.11243894774826524,
                -0.26420417695521153,
                -0.013528922235624206,
                0.03367628487978862,
                -0.10329906811064456,
                0.13434903965073036,
                0.052890354086496914,
                -0.03619939112350377,
                -0.12904209626675994,
                -0.018978110017713795,
                -0.05139527811307812,
                0.06407543998501496,
                0.006721892687163957,
                0.014588257690109378,
                -0.33682496710111476,
                0.33659813239217,
                0.29198048557918205,
                -0.09442451240445798,
                ...
                0.13171849449095221,
                -0.23348045532290845,
                -0.052986678725985614,
                -0.07611586763311662,
                0.12329154707403572,
                -0.15431452325895045,
                0.11261604599348245,
                -0.08256243045372466,
                0.030362736991191373,
                -0.17154511531654407,
                -0.007841034221152862,
                0.019656583974934694,
                0.13093530881940213,
                -0.09478814812703654,
                0.005557905861399682,
                0.004197110181518123,
                0.06547563070898621,
                -0.024381473268004217,
                -0.10080233488541608,
                0.2877983882195142,
                0.043488940365089254,
                0.05110509698867507,
                -0.041188237783129626,
                0.14384890323488586,
                -0.06447339288935146,
                0.13593991358323781,
                -0.09417040545832327,
                0.07967008808203366,
                -0.03380852695083012,
                0.029820519981800433,
                0.07810520648754149,
                -0.03618270270440046,
                0.04334146886514824,
                0.054682461042266525,
                0.12774377543226134,
                -0.09800236494579438,
                -0.09983330373811815,
                -0.08257413950281575,
                -0.15532872193659292,
                -0.049222078363136954,
                -0.1402290712421924,
                -0.04897637317229591,
                0.2062434712026433,
            ]
            gaze_y = [
                ...
                -0.04307387478036936,
                0.22497900128897472,
                -0.016959455494268125,
                0.03494054025145829,
                0.022196027507524224,
                -0.2713770500555256,
                -0.14226625547528784,
                0.19479677270416862,
                -0.049733211822404734,
                -0.024087906000181784,
                -0.21309497507583042,
                0.08119081770801623,
                0.10063888739728503,
                -0.11685846756074074,
                -0.014090323378536614,
                -0.010982286694819234,
                0.1275293525888344,
                0.038201534428959474,
                -0.02843981639721804,
                -0.14163320776601196,
                0.17520169732506344,
                0.14794258205650956,
                -0.030405996636998,
                -0.005257262277572071,
                -0.1894755758151676,
                -0.12110684431674518,
                -0.09059612577072398,
                -0.18762061037452246,
                -0.06688391436406245,
                0.044836512446305286,
                -0.02762884914060871,
                0.12126035974350613,
                -0.19142377402809638,
                -0.1098629489107521,
                0.0073232617145572694,
                0.24082908182868892,
                0.18228469015922505,
                -0.05831260304929317,
                -0.05470379183195077,
                ...
                -0.2235165493810558,
                0.05732678966381335,
                -0.055546042817886776,
                -0.21286277988442912,
                0.08158436664654198,
                -0.1611661853901306,
                -0.013624447209764266,
                -0.08116865383558444,
                -0.023983015263859608,
                0.31527867777217755,
                0.005185525287965387,
                -0.1238309874422757,
                -0.1915895198481792,
                -0.17092571682416308,
                -0.03557307338910428,
                0.10209799462918365,
                0.07389723739220574,
                -0.023289145819777715,
                0.005579934837707246,
                0.2959015090678081,
                0.11643880931294513,
                0.022615497786472878,
                0.0994332281785743,
                -0.157429722587906,
                -0.14906995476437326,
                -0.0835302357575882,
                0.059474995289160476,
                -0.20062156219809146,
                0.03546294869146381,
                -0.1860314131405205,
                0.04343695427863678,
                ...
                -0.2030848318477704,
                0.13598908763494152,
                -0.015842466150384163,
                -0.04558793882802181,
                -0.10240949309598955,
                -0.003887139913982443,
                0.11398274486249155,
                -0.07083927895912932,
                0.06597038928337104,
                0.4,
                0.0019139758929728758,
                0.12164049182550815,
                -0.038036639081372704,
                0.08620440190451532,
                -0.021767655579001236,
                -0.02985365550613488,
                -0.08999830507417202,
                -0.1375646873613005,
                0.1787509758733869,
        ...
        readability_score = readability.readibility_score(
...
async def upload_video_chunk(
    job_id: str, background_tasks: BackgroundTasks, file: UploadFile = File(...)
):
    """
        ...
        async with aiofiles.open(file_path, "wb") as buffer:
            ...
            while True:
                try:
                    ...
                    if job["file_size"] > 0:
                        progress = min(
                            int((total_bytes / job["file_size"]) * 80), 80
                        )  # Up to 80% for upload
            ...
            logger.info(
                f"File save completed for job {job_id}: {total_bytes} bytes in {elapsed:.2f}s"
            )
...
@app.post("/api/upload")
async def upload_video_immediate(
...
async def list_jobs():
    ...
    jobs_summary = {
        job_id: {k: v for k, v in job.items() if k != "results"}
