...
document.addEventListener('DOMContentLoaded', () => __awaiter(this, void 0, void 0, function* () {
    ...
    function renderResults(results) {
        ...
        if (results.custom_tone_results && results.custom_tone_results.length > 0) {
            ...
            sentimentList.innerHTML = results.custom_tone_results.map(([score, label, emoji]) => `<li class="flex items-center space-x-2">
        ...
        if (results.extra_tone_results && results.extra_tone_results.length > 0) {
            ...
            extraList.innerHTML = results.extra_tone_results.map(([score, label, emoji], idx) => `<li class="flex items-center space-x-2">
        ...
        // Copy button
        document.getElementById('copyBtn').addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            try {
                yield navigator.clipboard.writeText(results.corrected_transcript || results.transcript);
        ...
        if (results.grammar_mistakes && results.grammar_mistakes.length > 0) {
            ...
            grammarList.innerHTML = results.grammar_mistakes.map(([range, suggestion, original]) => `<li>"${original}" should be "${suggestion}"</li>`).join('');
    ...
    // PDF Download
    if (downloadPdfBtn) {
        downloadPdfBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
