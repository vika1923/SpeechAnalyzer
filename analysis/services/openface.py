...
def extract_video(
    ...
    out_dir,
    file_name="video",
    openface_path="/opt/OpenFace/build/bin/FeatureExtraction",
):
    subprocess.run(
        [
...
def extract_and_get_info(
    file_path,
    openface_path="/Users/almaz/PycharmProjects/SpeechAnalyzer/openFace/OpenFace/build/bin/FeatureExtraction",
    temp_dir="/Users/almaz/PycharmProjects/SpeechAnalyzer/videos/tests",
):
    try:
        # temp_dir = "/app/videos/openface"  # Use absolute path that exists in container
        extract_video(file_path, temp_dir, openface_path=openface_path)
...
if __name__ == "__main__":
    print("Hello")
    numbers = extract_and_get_info(
        "/Users/almaz/PycharmProjects/SpeechAnalyzer/videos/Vika.mov",
